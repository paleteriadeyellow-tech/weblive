...
export const DEFAULT_SETTINGS = {
  ...
  tts: {
    ...
    // Piper (gratis, solo .exe). Binario y voces se descargan a DATA_DIR, no al instalador.
    piper: {
      enabled: false,
  ...
  // Pelota de regalos (1080×1920, fondo transparente)
  batallaGiftBall: {
    enabled: true,
  ...
  // Contador de monedas (barra vertical de metas / retos en Batalla Overlay)
  batallaCoinBar: {
    source: 'battle', // 'battle' = PK hostScore | 'live' = diamantes del live
    resetPeriod: 'battle', // battle | live | week | month — no borrar hasta cumplir el periodo
    scale: 100,
    textSize: 100,
    numSize: 100,
    goals: [
  ...
  // Overlay Sorteos vidas (gestión manual + eliminación rápida)
  sorteosVidasOverlay: {
    entryCost: 30,
    entryGiftImage: '',
    entryGiftId: '',
  ...
  // Overlay Sorteo de puntos de usuario (solo comando + puntos)
  sorteosPavosOverlay: {
    entryCost: 500,
    entryGiftImage: '',
    entryGiftId: '',
