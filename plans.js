...
export const CAPABILITIES = {
  ...
  overlays: [
    ...
    { key: 'ov_giftheart', label: 'Meta Heart Me', path: '/corazon-lava.html' },
    { key: 'ov_giftgoals', label: 'Metas de regalos', path: '/gift-metas.html' },
    ...
    { key: 'ov_winscounterpro', label: 'Contador de victorias PRO (5 diseños)', path: '/contador-wins-pro.html' },
    ...
    { key: 'ov_baileronda', label: 'Overlay baile — Ronda', path: '/baile-ronda.html' },
    ...
    { key: 'ov_ultimoregalo', label: 'Último regalo', path: '/ultimoregalo.html' },
    ...
    { key: 'ov_giftroulette', label: 'Ruleta de regalos', path: '/ruleta-regalos.html' },
